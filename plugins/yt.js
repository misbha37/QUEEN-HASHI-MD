  ...
  async (
    ...
    try {
      ...
      const _0xe6e753 = await yts(_0xe784cf),
        _0x404968 = _0xe6e753.videos[0],
        _0x1816d0 = _0x404968.url
      let _0x1932ca =
          '\uD83C\uDFA7 \uD835\uDDE6\uD835\uDDD8\uD835\uDDE2\uD835\uDDE1 \uD835\uDDE0\uD835\uDDD7 \uD835\uDDE0\uD835\uDDE8\uD835\uDDE6\uD835\uDDDC\uD835\uDDD6 \uD835\uDDD7\uD835\uDDE2\uD835\uDDEA\uD835\uDDE1\uD835\uDDDF\uD835\uDDE2\uD835\uDDD4\uD835\uDDD7\uD835\uDDD8\uD835\uDDE5 \uD83D\uDCE5\n\n*\u2605| TITLE :* ' +
          _0x404968.title +
          '\n\n*\u2605| TIME :* ' +
          _0x404968.timestamp +
          '\n\n*\u2605| DURATION :* ' +
          _0x404968.description +
          '\n\n*\u2605| AGO :* ' +
          _0x404968.ago +
          '\n\n*\u2605| VIEWS :* ' +
          _0x404968.views +
      ...
      const _0x5293dd = await _0x4ed46a.sendMessage(
        _0x1d8932,
        {
          image: { url: _0x404968.thumbnail },
          caption: _0x1932ca,
        },
        { quoted: _0x513182 }
      )
      _0x4ed46a.ev.on('messages.upsert', async (_0x251d48) => {
        const _0x2dc106 = _0x251d48.messages[0]
        if (!_0x2dc106.message || !_0x2dc106.message.extendedTextMessage) {
          return
        }
        if (
          _0x2dc106.message.extendedTextMessage.contextInfo &&
          _0x2dc106.message.extendedTextMessage.contextInfo.stanzaId ===
            _0x5293dd.key.id
        ) {
  ...
  async (
    ...
    try {
      ...
      const _0x20de37 = await yts(_0x424fd9),
        _0x1e9340 = _0x20de37.videos[0],
        _0xacc2cb = _0x1e9340.url
      let _0x26dedb =
          '\uD83C\uDFA7 \uD835\uDDE6\uD835\uDDD8\uD835\uDDE2\uD835\uDDE1 \uD835\uDDE0\uD835\uDDD7 \uD835\uDDE9\uD835\uDDDC\uD835\uDDD7\uD835\uDDD8\uD835\uDDE2 \uD835\uDDD7\uD835\uDDE2\uD835\uDDEA\uD835\uDDE1\uD835\uDDDF\uD835\uDDE2\uD835\uDDD4\uD835\uDDD7\uD835\uDDD8\uD835\uDDE5 \uD83D\uDCE5\n\n*\u2605| TITLE :* ' +
          _0x1e9340.title +
          '\n\n*\u2605| TIME :* ' +
          _0x1e9340.timestamp +
          '\n\n*\u2605| DURATION :* ' +
          _0x1e9340.description +
          '\n\n*\u2605| AGO :* ' +
          _0x1e9340.ago +
          '\n\n*\u2605| VIEWS :* ' +
          _0x1e9340.views +
      ...
      const _0x26c67c = await _0x2e46b2.sendMessage(
        _0x3abd35,
        {
          image: { url: _0x1e9340.thumbnail },
          caption: _0x26dedb,
        },
        { quoted: _0x321b59 }
      )
      _0x2e46b2.ev.on('messages.upsert', async (_0x9d6b12) => {
        const _0x3e4915 = _0x9d6b12.messages[0]
        if (!_0x3e4915.message || !_0x3e4915.message.extendedTextMessage) {
          return
        }
        if (
          _0x3e4915.message.extendedTextMessage.contextInfo &&
          _0x3e4915.message.extendedTextMessage.contextInfo.stanzaId ===
            _0x26c67c.key.id
        ) {
